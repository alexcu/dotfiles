# Generated by Powerlevel10k configuration wizard on 2024-03-19 at 10:29 AEDT.
...
() {
  ...
  # Place instant prompt at the bottom of the terminal
  # See: https://github.com/romkatv/powerlevel10k/issues/563#issuecomment-599010321
  #printf '\n%.0s' {1..100}
